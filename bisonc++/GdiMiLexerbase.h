...
#ifndef GdiMiLexerBASE_H_INCLUDED
#define GdiMiLexerBASE_H_INCLUDED
...
private:
    ...
    size_t (GdiMiLexerBase::*d_get)() = &GdiMiLexerBase::getInput;
...
public:
    GdiMiLexerBase(GdiMiLexerBase const &other)             = delete;
    GdiMiLexerBase &operator=(GdiMiLexerBase const &rhs)    = delete;
...
protected:
    GdiMiLexerBase(std::istream &in, std::ostream &out);
    GdiMiLexerBase(std::string const &infilename, std::string const &outfilename);
    ~GdiMiLexerBase();
...
inline GdiMiLexerBase::~GdiMiLexerBase()
{
    d_input->close();
}

template <typename ReturnType, typename ArgType>
inline ReturnType constexpr GdiMiLexerBase::as(ArgType value)
{
    return static_cast<ReturnType>(value);
}

// $insert startcondimpl
inline GdiMiLexerBase::StartCondition_ constexpr GdiMiLexerBase::SC(int sc)
{
    return as<StartCondition_>(sc);
}

inline int constexpr GdiMiLexerBase::SC(StartCondition_ sc)
{
    return as<int>(sc);
}

inline GdiMiLexerBase::StartCondition_ GdiMiLexerBase::startCondition() const
{
    return SC(d_startCondition);
}

inline void GdiMiLexerBase::begin(StartCondition_ startCondition)
{
    // d_state is reset to 0 by reset_()
    d_dfaBase_ = s_dfaBase_[d_startCondition = SC(startCondition)];
}

inline bool GdiMiLexerBase::knownFinalState()
{
    return (d_atBOL && available(d_final.bol.rule)) ||
           available(d_final.std.rule);
}

inline bool constexpr GdiMiLexerBase::available(size_t value)
{   
    return value != std::numeric_limits<size_t>::max();
}

inline std::ostream &GdiMiLexerBase::out()
{
    return *d_out;
}

inline void GdiMiLexerBase::push(size_t ch)
{
    d_input->reRead(ch);
}

inline void GdiMiLexerBase::push(std::string const &str)
{
    d_input->reRead(str, 0);
}


inline std::vector<GdiMiLexerBase::StreamStruct> const &GdiMiLexerBase::streamStack() const
{
...
inline void GdiMiLexerBase::setFilename(std::string const &name)
{
    d_filename = name;
}

inline void GdiMiLexerBase::setMatched(std::string const &text)
{
    d_matched = text;
}

inline std::string const &GdiMiLexerBase::matched() const
{
    return d_matched;
}

inline std::string const &GdiMiLexerBase::filename() const
{
    return d_filename;
}

inline void GdiMiLexerBase::echo() const
{
    *d_out << d_matched;
}

inline size_t GdiMiLexerBase::length() const
{
    return d_matched.size();
}

inline void GdiMiLexerBase::leave(int retValue) const
{
    throw as<Leave_>(retValue);
}

inline size_t GdiMiLexerBase::lineNr() const
{
    return d_input->lineNr();
}

inline void GdiMiLexerBase::more()
{
    d_more = true;
}

inline size_t GdiMiLexerBase::state_() const
{
    return d_state;
}

inline size_t GdiMiLexerBase::get_()
{
    return (this->*d_get)();
}

inline size_t GdiMiLexerBase::getInput()
{
    return d_input->get();
}

inline bool GdiMiLexerBase::return_()
{
    return d_return;
}

inline void GdiMiLexerBase::noReturn_()
{
    d_return = false;
}


#endif //  GdiMiLexerBASE_H_INCLUDED
